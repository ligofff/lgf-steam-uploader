...
1. Make an [Issue](https://github.com/ligofff/lgf-steam-uploader/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-steam-uploader": "https://github.com/YOUR_USER/lgf-steam-uploader.git"
        }
    }
```
